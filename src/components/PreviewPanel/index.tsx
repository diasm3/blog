...
import { DefaultMarkdownComponents } from "../MarkdownParser"
import { TableOfContents } from "./TocPreview"
...
export const PreviewPanel: React.FC<{
...
}> = ({ isVisible, isPinned, onTogglePin }) => {
  ...
  //     .map((block) => getLastVersionText(block.id))
  ...
  return (
    <S.RightPanel $isVisible={isVisible} $isPinned={isPinned}>
      ...
      <S.TabContent>
        ...
        {activeTab === "toc" && <TableOfContents content={""} />}
      </S.TabContent>
    </S.RightPanel>
  )
}
